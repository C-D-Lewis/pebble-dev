...
void scalable_init() {
  ...
  scl_set_fonts(SFI_Small, {.o = s_font_g18, .e = s_font_g24, .g = s_font_g24});
  scl_set_fonts(SFI_Medium, {.o = s_font_g24, .e = s_font_g28, .g = s_font_g28});
  scl_set_fonts(SFI_MediumBold, {.o = s_font_g24_b, .e = s_font_g28_b, .g = s_font_g28_b});
  scl_set_fonts(SFI_Large, {.o = s_font_g28, .e = s_font_g28, .g = s_font_g28});
#if defined(PBL_PLATFORM_EMERY) || defined(PBL_PLATFORM_GABBRO)
  scl_set_fonts(SFI_LargeBold, {.o = s_font_g28_b, .e = s_font_gg30, .g = s_font_gg30});
#else
  // On Aplite, largest font is never used, save space
  scl_set_fonts(SFI_LargeBold, {.o = s_font_g28_b, .e = s_font_g28_b, .g = s_font_g28_b});
#endif
}
