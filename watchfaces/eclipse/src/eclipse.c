// TODO Use window dimensions to support chalk platform
...
static void window_load(Window *window) {
  ...
  time_layer = cl_text_layer_create(GRECT_TIME_BG_HIDDEN, GColorBlack, GColorClear, false, 0, FONT_KEY_GOTHIC_24_BOLD, GTextAlignmentCenter);
  ...
  date_layer = cl_text_layer_create(GRECT_DATE_BG_HIDDEN, GColorBlack, GColorClear, false, 0, FONT_KEY_GOTHIC_24_BOLD, GTextAlignmentCenter);
  ...
  // Animate in
  cl_animate_layer(phase_layer, GRECT_PHASE_HIDDEN, GRECT_PHASE_SHOWING, 1000, 200, initial_anim_stopped_handler);
}
...
static void stat_timer_callback(void *data) {
  // Show phase
  cl_animate_layer(phase_layer, GRECT_PHASE_HIDDEN, GRECT_PHASE_SHOWING, 1000, 0, NULL);

  // Hide time
  cl_animate_layer(time_bg_layer, GRECT_TIME_BG_SHOWING, GRECT_TIME_BG_HIDDEN, 500, 0, NULL);
  cl_animate_layer(text_layer_get_layer(time_layer), GRECT_TIME_SHOWING, GRECT_TIME_HIDDEN, 500, 0, NULL);

  // Hide battery
  cl_animate_layer(battery_layer, GRECT_BATTERY_SHOWING, GRECT_BATTERY_HIDDEN, 500, 0, NULL);

  // Hide date
  cl_animate_layer(date_bg_layer, GRECT_DATE_BG_SHOWING, GRECT_DATE_BG_HIDDEN, 500, 0, NULL);
  cl_animate_layer(text_layer_get_layer(date_layer), GRECT_DATE_SHOWING, GRECT_DATE_BG_HIDDEN, 500, 0, NULL);

  cl_animate_layer(bitmap_layer_get_layer(bt_layer), GRECT_BT_SHOWING, GRECT_BT_HIDDEN, 500, 0, NULL);
...
static void accel_tap_handler(AccelAxisType axis, int32_t direction) {
  if (triggd == false) {
    ...
    // Hide phase
    cl_animate_layer(phase_layer, layer_get_frame(phase_layer), GRect(144, 59, 144, 51), 500, 100, NULL);

    // Show time
    cl_animate_layer(time_bg_layer, GRECT_TIME_BG_HIDDEN, GRECT_TIME_BG_SHOWING, 500, 100, NULL);
    cl_animate_layer(text_layer_get_layer(time_layer), GRECT_TIME_HIDDEN, GRECT_TIME_SHOWING, 500, 100, NULL);

    // Show battery
    cl_animate_layer(battery_layer, GRECT_BATTERY_HIDDEN, GRECT_BATTERY_SHOWING, 500, 100, NULL);

    // Show date
    cl_animate_layer(date_bg_layer, GRECT_DATE_BG_HIDDEN, GRECT_DATE_BG_SHOWING, 500, 100, NULL);
    cl_animate_layer(text_layer_get_layer(date_layer), GRECT_DATE_BG_HIDDEN, GRECT_DATE_SHOWING, 500, 100, NULL);

    // Animate bluetooth layer
    cl_animate_layer(bitmap_layer_get_layer(bt_layer), GRECT_BT_HIDDEN, GRECT_BT_SHOWING, 500, 100, NULL);
