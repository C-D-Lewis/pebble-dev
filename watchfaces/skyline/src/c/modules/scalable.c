...
void scalable_init() {
  ...
  scl_set_fonts(SFI_Dial, {.o = s_font_18});
  scl_set_fonts(SFI_Date, {.c = s_font_18, .e = s_font_18, .g = s_font_24});
  scl_set_fonts(SFI_Time, {.c = s_font_38, .e = s_font_38, .g = s_font_55});
}
