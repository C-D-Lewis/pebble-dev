...
static GFont s_font_14, s_font_18, s_font_24, s_font_30, s_font_38, s_font_55;
...
void scalable_init() {
  ...
  scl_set_fonts(SFI_Weather, {.o = s_font_14, .c = s_font_18, .e = s_font_18, .g = s_font_24});
  scl_set_fonts(SFI_Date, {.o = s_font_14, .c = s_font_18, .e = s_font_18, .g = s_font_24});
